...
const TotalStaked: React.FC<MultiplierProps> = ({ multiplier }) => {
  ...
  const tooltipContent = (
    <>
      <Text>
        {t(
          'The Multiplier represents the proportion of XALO rewards each farm receives, as a proportion of the XALO produced each block.',
        )}
      </Text>
      <Text my="24px">
        {t('For example, if a 1x farm received 1 XALO per block, a 40x farm would receive 40 XALO per block.')}
      </Text>
